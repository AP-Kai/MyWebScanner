            ...
            $("#startsqli").click(function () {
                $.ajax({
                    ...
                    success: function (result) {
                        console.log("success")
                        $("#content").text(result.injectContent);
                        window.alert("检测结束，报告已生成。报告的地址是：D:/document.txt")
...
<div class="container">
    ...
    <div class="right">
        ...
        <button id="startsqli">开始进行SQL注入</button>
